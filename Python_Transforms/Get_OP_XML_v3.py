...
import Python_Resources.get_part1_xml_cmd_v3 as part1_script
# this is the brains of the fba operation
import Python_Resources.get_fba_xml_cmd_v3 as fba_script
# this is the brains of the announcements operation
import Python_Resources.get_announcements_xml_cmd_v2 as ann_script
...
class EBApp:
    def __init__(self, master):
        ...
        self.select_folder_button = ttk.Button(self.step_1, text="Select Folder", width=12,
                                               command=self.get_folder_for_outputs)
        ...
        # run button
        self.part1_button = ttk.Button(self.step_3, text="Get Part 1 XML", width=26,
                                       command=self.run_part1_comand_line_script)
        # self.run_Transform_VnP_XML_button.config()
        self.part1_button.grid(row=rows.count(), column=0, padx=10, pady=10)
        # Announcements Button
        self.FBA_button = ttk.Button(self.step_3, text="Get Announcements XML", width=26,
                                     command=self.run_ann_comand_line_script)
    ...
    def run_part1_comand_line_script(self):
        ...
        output_file_name = os.path.join(folder_path, 'as-downloaded-' + op_date + '.xml')
