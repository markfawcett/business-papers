    ...
    for i in range(len(bus_of_day_paras)):
        ...
        if bus_of_day_paras[i].get('class') in ('paraBusinessItemHeading', 'BulletedCaps'):
            ...
            for k in range(j - 1):
                ...
                if current_class in ('Normal', 'paraMotionNumberedParagraph', 'paraMotionText', 'SubNumberedPara', 'NumberedParaEmpty', 'NormalIndented', 'paraMotionSub-Paragraph', 'paraMotionSub-Sub-Paragraph'):
