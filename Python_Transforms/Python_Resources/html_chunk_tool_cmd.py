...
class DATES:
    ...
    # in the form, 'Monday 12 September 2016'
    sitting_date_long      = ""
    ...
    # 20160912
    sitting_date_compact   = ""

    # 160912
    sitting_date_super_compact = ""

    # 11 September 2016
    creation_date_medium   = ""
...
def split_and_output(input_root, template_file_name, input_file_name):
    ...
    for file_lable, element_list in file_lables_element_lists.items():
        if len(element_list) != 0:
            ...
            filename = file_lable + DATES.sitting_date_compact + fileextension
            ...
            # change the title
            if file_lable == 'ob':
                title_text = 'Business for ' + DATES.sitting_date_long
            elif file_lable == 'fb':
                title_text = 'Future Business as of ' + DATES.sitting_date_long
            elif file_lable == 'an':
                title_text = 'Announcements for ' + DATES.sitting_date_long
